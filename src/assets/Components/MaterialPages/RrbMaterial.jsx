    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
            ...
            <section
                ...
                style={{ background: `linear-gradient(135deg, ${GOLD}, #da9100, #da9100)` }}
            >
                ...
                <div className="max-w-[600px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    >
                        ...
                        <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                            We are preparing comprehensive study materials for RRB exams. Please check back shortly for updated resources.
                        </p>
                    </div>
                </div>
            </section>
